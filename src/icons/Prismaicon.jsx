    ...
    return (
        <div className="skill-card bg-[#0e223f] hover:text-[#FFA500] hover:cursor-pointer py-8 flex justify-center rounded-md">
            <div className="space-y-3">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" role="img" viewBox="-27 0 310 310" className="mx-auto" height="3em" width="3em" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <title></title>
                    <g>
                ...
                <p className="form-text text-center">Prisma</p>
            </div>
        </div>
    )
}
